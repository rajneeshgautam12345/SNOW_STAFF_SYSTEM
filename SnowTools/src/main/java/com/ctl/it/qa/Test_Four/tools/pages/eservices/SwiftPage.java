...
//	@FindBy(xpath = "//span[@class='boldfont requiredDocType'][contains(.,'Service Order Form')]")
	...
	// @FindBy(xpath= "//select[contains(@id,'endUserClliDropDown')]/option[contains
	// (@value,'SL0000031877')]")
...
//	@FindBy(xpath = "//span[@class='k-link'][contains(.,'Filter')])[1]")
//	@FindBy(xpath = "//span[@class='k-link k-state-active k-state-border-left'][contains(.,'Filter')]")
