...
Feature: Service Now DIA E2E Scenarios
  ...
  Scenario Outline: TC-01-DIA Onnet Order submit to snow
    ...
    Examples: 
      ...
      | Costco Wholesale Corporation |     2 | DNVFCOQE | Floor 5 Room WLAB | COLORADO | PL0027228028 | Dedicated Internet Access | GigE - Ethernet Switched Access (50-1,000) | 1000 Mbps          | Flat Rate     | Standard Delivery - To the MPoE (Customer Provided) | No               | 1000 | 1000 |   36 | No             | Managed Router and Managed Integrated Access Device | CISCO C4451X-ET-01 and CISCO C4451X-T1-01 | Level 3 Provided |         3 | DIA_Simple_Onnet | Andrew Parada |
  ...
  Scenario Outline: TC-02-DIA Offnet Order submit to snow
    ...
    Examples: 
      | sAccount                     | pdays | faddress | floorAndRoom      | fstate   | fplcode      | smyproduct                | bandwidth                                  | accessSubbandwidth | billingMethod | buildingExt                                         | multipleLogicals | pdr  | cdr  | term | managedService | managedServiceType | kitName | cpeProvider | futureday | scenario          | contact       |
      | Costco Wholesale Corporation |     2 | BNNTCOAP | Floor 1 Room TELC | COLORADO | PL0031189037 | Dedicated Internet Access | GigE - Ethernet Switched Access (50-1,000) | 1000 Mbps          | Flat Rate     | Standard Delivery - To the MPoE (Customer Provided) | No               | 1000 | 1000 |   36 | No             |                    |         |             |         3 | DIA_Simple_Offnet | Andrew Parada |
  ...
  Scenario Outline: TC-06-DIA Onnet ASRI manual submit to snow
    ...
    Examples: 
      | sAccount                     | pdays | faddress | floorAndRoom      | fstate   | fplcode      | smyproduct                | bandwidth                                  | accessSubbandwidth | billingMethod | buildingExt                                         | multipleLogicals | pdr  | cdr  | term | managedService | managedServiceType                                  | kitName                                   | cpeProvider      | futureday | scenario              | contact       |
      | Costco Wholesale Corporation |     2 | ATLA134O | Floor 1 Room LL10 | COLORADO | PL0027228028 | Dedicated Internet Access | GigE - Ethernet Switched Access (50-1,000) | 1000 Mbps          | Flat Rate     | Standard Delivery - To the MPoE (Customer Provided) | No               | 1000 | 1000 |   36 | No             | Managed Router and Managed Integrated Access Device | CISCO C4451X-ET-01 and CISCO C4451X-T1-01 | Level 3 Provided |         3 | DIA_Onnet_ASRI_Manual | Andrew Parada |
  ...
  Scenario Outline: TC-07-DIA Onnet Wave order submit to snow
    ...
    Examples: 
      ...
      | Costco Wholesale Corporation |     2 | NWYK36G2 | Floor 43 Room MDF | NEWYORK | PL0027228028 | Dedicated Internet Access | 10 Gig LanWave - Wave Access (500-10,000) | 1000 Mbps          | Flat Rate     | Standard Delivery - To the MPoE (Customer Provided) | No               | 1000 | 1000 |   36 | No             | Managed Router and Managed Integrated Access Device | CISCO C4451X-ET-01 and CISCO C4451X-T1-01 | Level 3 Provided |         3 | DIA_Onnet_Wave | Andrew Parada |
  ...
  Scenario Outline: TC-08-DIA Onnet with BE Order submit to snow
    ...
    Examples: 
      | sAccount                     | pdays | faddress | floorAndRoom      | fstate   | fplcode      | smyproduct                | bandwidth                                  | accessSubbandwidth | billingMethod | buildingExt                                                | multipleLogicals | pdr  | cdr  | term | managedService | managedServiceType | kitName | cpeProvider | futureday | scenario          | contact       |
      | Costco Wholesale Corporation |     2 | DNVFCOQE | Floor 5 Room WLAB | COLORADO | PL0031189037 | Dedicated Internet Access | GigE - Ethernet Switched Access (50-1,000) | 1000 Mbps          | Flat Rate     | Extended Delivery - To the Customer Suite (Lumen Provided) | No               | 1000 | 1000 |   36 | No             |                    |         |             |         3 | DIA_Onnet_With_BE | Andrew Parada |
  ...
  Scenario Outline: TC-10-DIA Offnet wave bandwidth Order submit to snow
    ...
    Examples: 
      | sAccount                     | pdays | faddress | floorAndRoom     | fstate   | fplcode      | smyproduct                | bandwidth                                 | accessSubbandwidth | billingMethod | buildingExt                                         | multipleLogicals | pdr  | cdr  | term | managedService | managedServiceType                                  | kitName                                   | cpeProvider      | futureday | scenario        | contact       |
      | Costco Wholesale Corporation |     2 | LSAHCAXP | Floor 4 Room MMR | COLORADO | PL0027228028 | Dedicated Internet Access | 10 Gig LanWave - Wave Access (500-10,000) | 1000 Mbps          | Flat Rate     | Standard Delivery - To the MPoE (Customer Provided) | No               | 1000 | 1000 |   36 | No             | Managed Router and Managed Integrated Access Device | CISCO C4451X-ET-01 and CISCO C4451X-T1-01 | Level 3 Provided |         3 | DIA_Offnet_Wave | Andrew Parada |
...
@All_Scenario
  ...
  Scenario Outline: TC-11-DIA Offnet GPOM Order submit to snow
    ...
    Examples: 
      ...
      | Costco Wholesale Corporation |     2 | CLMBGABA | Floor 1 Room TELC | COLORADO | PL0031189037 | Dedicated Internet Access | GigE - Ethernet Switched Access (50-1,000) | 1000 Mbps          | Level 3 - BELLSOUTH TELECOMM INC - GA -> Level3 - 1000 - 1000 - Best Effort - Pt-Pt - ILEC - USD - $656.25 - $0.00 | Flat Rate     | Standard Delivery - To the MPoE (Customer Provided) | No               | 1000 | 1000 |   36 | No             |                    |         |             |         3 | DIA_Offnet_GPOM | Andrew Parada |
  ...
  Scenario Outline: TC-13-DIA Colorless Simply Onnet order submit to snow
    ...
    Examples: 
      | sAccount                     | pdays | faddress | floorAndRoom      | fstate   | fplcode      | smyproduct                | bandwidth                                  | accessSubbandwidth | billingMethod | buildingExt                                         | multipleLogicals | pdr  | cdr  | term | managedService | managedServiceType | kitName           | cpeProvider      | futureday | scenario      | contact       |
      | Costco Wholesale Corporation |     2 | SLKCUTSC | Floor 1 Room 9999 | COLORADO | SL0003313633 | Dedicated Internet Access | GigE - Ethernet Switched Access (50-1,000) | 1000 Mbps          | Flat Rate     | Standard Delivery - To the MPoE (Customer Provided) | No               | 1000 | 1000 |   36 | No             | Managed Router     | CISCO C4431-ET-01 | Level 3 Provided |         3 | DIA_Affiliate | Andrew Parada |
